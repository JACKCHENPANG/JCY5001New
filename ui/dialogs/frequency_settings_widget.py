...
class FrequencySettingsWidget(QWidget):
    ...
    def _get_basic_preset_frequencies(self) -> dict:
        ...
        original_presets = {
            ...
            "生产模式": [0.119, 1.0, 10.0, 100.0, 1000.0],
            "定频1kHz": [1000.0],
    ...
    def _create_preset_layout(self) -> QVBoxLayout:
        ...
        self.production_radio.setToolTip("0.119Hz, 1Hz, 10Hz, 100Hz, 1kHz，5个频点\n适用于生产线快速测试")
        self.preset_button_group.addButton(self.production_radio, 1)
        layout.addWidget(self.production_radio)

        # 定频1kHz模式
        self.fixed_1khz_radio = QRadioButton("定频1kHz")
        self.fixed_1khz_radio.setToolTip("1000Hz单频点\n适用于定频测试设备模式\nRs显示实部值，Rct显示0")
        self.preset_button_group.addButton(self.fixed_1khz_radio, 2)
        layout.addWidget(self.fixed_1khz_radio)
